...
// Retrieve SIREN from the session or cookie, whichever is appropriate for your use case
...
echo "
    <div class='box'>
        ...
        <center>
            <form action='impaye_client.php' method='post'>
                <br>
...
if (isset($_POST['submit'])) {
    ...
    if ($dated > $datef) {
        ...
        $results = $dbh->query("
            SELECT SIREN, DATE_VENTE, DateTraitement, NumCarte, Reseau, NumDossierImp, MONTANT, LibelleImp 
